  ...
  return (
    <>
      <section className="d-flex flex-md-row flex-column vh-100 p-0 m-0">
        ...
        <aside className="w-100 h-100 overflow-hidden">
          <img
            className="img-fluid"
            src={imgBackgraund}
      ...
      <section className="d-flex flex-column justify-content-center align-items-center vh-100 p-5 m-0">
        <div className="d-flex justify-content-center w-100 p-0 m-0">
            <h1>Sobre lo que hacemos</h1>
        </div>
        <div className="row text-center justify-content-center w-100 p-0 m-0">
        ...
        <ul className="d-flex justify-content-start align-itmes-center overflow-auto w-100 gap-5 p-0 m-0">
          <CardServices
            imageUrl={imgDevWeb}
