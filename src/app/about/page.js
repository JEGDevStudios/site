      ...
      <article className="d-flex flex-column w-100 p-5 m-0">
        <div>
          ...
          <p>
            ...
            proposito de convertirnos en un equipo de desarrolladores y
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <strong>Aplicaciones Móviles:</strong> Creamos aplicaciones
            ...
            <li>
              <strong>Desarrollo de Videojuegos:</strong> Creamos experiencias
